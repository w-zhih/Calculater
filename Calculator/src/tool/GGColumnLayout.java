 ...
 * 
 */
public class GGColumnLayout implements LayoutManager2
{
	private List<Item> items = new ArrayList<>();
	private int gap = 2;
	private boolean usePerferredSize = false; // 竖立方向是否占满
	
	public GGColumnLayout()
	{		
	}
	public GGColumnLayout(int gap)
	{		
		this.gap = gap; // 控件之间的间距
	}
	public GGColumnLayout(int gap, boolean usePerferredSize)
	{	
		this.gap = gap;
